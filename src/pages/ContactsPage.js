...
//import ContactsComposition from '../components/ContactsComposition'
    ...
    <div className="ani-icon-composition">
      ...
      <div className="ani-icon ani-icon-phone">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
          ...
          <path fill="#0278AA" d="M343.63 117.202L470.608 349.24H41.392l126.976-232.038V68.926c0-3.277 2.65-5.94 5.928-5.94h22.426c3.277 0 5.928 2.663 5.928 5.94v48.276h106.7V68.926c0-3.277 2.65-5.94 5.928-5.94h22.426c3.277 0 5.928 2.663 5.928 5.94v48.276z"/>
          <path fill="#0A547B" d="M481.497 508.225H30.502c-4.713 0-8.533-3.82-8.533-8.533s3.82-8.533 8.532-8.533h450.996c4.713 0 8.533 3.82 8.533 8.532s-3.82 8.533-8.533 8.533z"/>
          <circle cx="256" cy="233.221" r="83.365" fill="#06344C"/>
          <g fill="#FFF">
